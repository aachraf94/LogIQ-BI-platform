...
export interface Translations {
  ...
  pages: {
    ...
    alerts: {
      ...
      kpiCategories: Record<string, string>
    }
    admin: {
      title: string
      subtitle: string
  ...
  pages: {
    ...
    alerts: {
      ...
      metricLabels: {
        ...
        pd_ops_total_parcels:       'Colis traités',
        pd_ops_delivered:           'Colis livrés',
        pd_ops_returns:             'Retours',
        pd_ops_in_transit:          'En transit',
        pd_ops_avg_duration:        'Durée moy. livraison (h)',
        // Parcel Delivery — Cost & Profitability
        pd_cost_fees_collected:     'Frais collectés (DZD)',
        pd_cost_total_cost:         'Coût opérationnel (DZD)',
        pd_cost_gross_margin:       'Marge brute (%)',
        pd_cost_avg_fee:            'Frais moy. / colis (DZD)',
        pd_cost_per_delivery:       'Coût / colis livré (DZD)',
        // Parcel Delivery — Performance
        pd_perf_delivery_rate:      'Taux de livraison (%)',
        pd_perf_avg_attempts:       'Tentatives moy.',
        pd_perf_first_attempt_rate: 'Succès 1ère tentative (%)',
        pd_perf_avg_duration:       'Durée moy. livraison (h)',
        pd_perf_claims_count:       'Sinistres déclarés',
        // Transport — Operations
        tr_ops_total_requests:      'Demandes totales',
        tr_ops_completion_rate:     'Taux de complétion (%)',
        tr_ops_cancellation_rate:   "Taux d'annulation (%)",
        tr_ops_avg_distance:        'Distance moy. (km)',
        tr_ops_avg_stops:           'Arrêts moy. / demande',
        // Transport — Cost & Profitability
        tr_cost_total_revenue:      'Revenu total (DZD)',
        tr_cost_total_cost:         'Coût total (DZD)',
        tr_cost_gross_margin:       'Marge brute (DZD)',
        tr_cost_margin_pct:         'Marge (%)',
        tr_cost_per_km:             'Coût / km (DZD)',
        // Transport — Performance
        tr_perf_on_time_rate:       'Ponctualité (%)',
        tr_perf_avg_duration:       'Durée moy. (h)',
        tr_perf_avg_rating:         'Note client moy.',
        tr_perf_avg_delay:          'Retard arrivée moy. (min)',
        tr_perf_night_shift_rate:   'Taux de nuit (%)',
      },
      ...
      dashboardLabels: { transport: 'Transport à la demande', parcels: 'Livraison Colis' },
      operatorLabels: { gt: 'Supérieur à (>)', gte: 'Supérieur ou égal (≥)', lt: 'Inférieur à (<)', lte: 'Inférieur ou égal (≤)' },
      kpiCategories: { operations: 'Opérations', cost_profitability: 'Coûts & Rentabilité', performance: 'Performance' },
    },
    admin: {
      title: 'Vue Admin',
...
const en: Translations = {
  ...
  pages: {
    ...
    alerts: {
      ...
      metricLabels: {
        pd_ops_total_parcels:       'Parcels Handled',
        pd_ops_delivered:           'Delivered Parcels',
        pd_ops_returns:             'Returns',
        pd_ops_in_transit:          'In Transit',
        pd_ops_avg_duration:        'Avg Delivery Duration (h)',
        pd_cost_fees_collected:     'Fees Collected (DZD)',
        pd_cost_total_cost:         'Total Operational Cost (DZD)',
        pd_cost_gross_margin:       'Gross Margin (%)',
        pd_cost_avg_fee:            'Avg Fee / Parcel (DZD)',
        pd_cost_per_delivery:       'Cost / Delivered Parcel (DZD)',
        pd_perf_delivery_rate:      'Delivery Rate (%)',
        pd_perf_avg_attempts:       'Avg Attempts',
        pd_perf_first_attempt_rate: '1st Attempt Success (%)',
        pd_perf_avg_duration:       'Avg Delivery Duration (h)',
        pd_perf_claims_count:       'Claims Declared',
        tr_ops_total_requests:      'Total Requests',
        tr_ops_completion_rate:     'Completion Rate (%)',
        tr_ops_cancellation_rate:   'Cancellation Rate (%)',
        tr_ops_avg_distance:        'Avg Distance (km)',
        tr_ops_avg_stops:           'Avg Stops / Request',
        tr_cost_total_revenue:      'Total Revenue (DZD)',
        tr_cost_total_cost:         'Total Cost (DZD)',
        tr_cost_gross_margin:       'Gross Margin (DZD)',
        tr_cost_margin_pct:         'Margin (%)',
        tr_cost_per_km:             'Cost / km (DZD)',
        tr_perf_on_time_rate:       'On-Time Rate (%)',
        tr_perf_avg_duration:       'Avg Duration (h)',
        tr_perf_avg_rating:         'Avg Client Rating',
        tr_perf_avg_delay:          'Avg Arrival Delay (min)',
        tr_perf_night_shift_rate:   'Night Shift Rate (%)',
      },
      ...
      dashboardLabels: { transport: 'On-Demand Transport', parcels: 'Parcel Delivery' },
      operatorLabels: { gt: 'Greater than (>)', gte: 'Greater or equal (≥)', lt: 'Less than (<)', lte: 'Less or equal (≤)' },
      kpiCategories: { operations: 'Operations', cost_profitability: 'Cost & Profitability', performance: 'Performance' },
    },
    admin: {
...
const ar: Translations = {
  ...
  pages: {
    ...
    alerts: {
      ...
      metricLabels: {
        pd_ops_total_parcels:       'الطرود المعالجة',
        pd_ops_delivered:           'الطرود المُسلَّمة',
        pd_ops_returns:             'الإعادات',
        pd_ops_in_transit:          'في الطريق',
        pd_ops_avg_duration:        'متوسط مدة التوصيل (ساعة)',
        pd_cost_fees_collected:     'الرسوم المحصَّلة (دج)',
        pd_cost_total_cost:         'التكلفة التشغيلية الإجمالية (دج)',
        pd_cost_gross_margin:       'الهامش الإجمالي (%)',
        pd_cost_avg_fee:            'متوسط الرسوم / طرد (دج)',
        pd_cost_per_delivery:       'التكلفة / طرد مُسلَّم (دج)',
        pd_perf_delivery_rate:      'معدل التسليم (%)',
        pd_perf_avg_attempts:       'متوسط المحاولات',
        pd_perf_first_attempt_rate: 'نجاح المحاولة الأولى (%)',
        pd_perf_avg_duration:       'متوسط مدة التوصيل (ساعة)',
        pd_perf_claims_count:       'السينيستر المُصرَّح بها',
        tr_ops_total_requests:      'إجمالي الطلبات',
        tr_ops_completion_rate:     'معدل الإتمام (%)',
        tr_ops_cancellation_rate:   'معدل الإلغاء (%)',
        tr_ops_avg_distance:        'متوسط المسافة (كم)',
        tr_ops_avg_stops:           'متوسط التوقفات / طلب',
        tr_cost_total_revenue:      'إجمالي الإيرادات (دج)',
        tr_cost_total_cost:         'إجمالي التكاليف (دج)',
        tr_cost_gross_margin:       'الهامش الإجمالي (دج)',
        tr_cost_margin_pct:         'الهامش (%)',
        tr_cost_per_km:             'التكلفة / كم (دج)',
        tr_perf_on_time_rate:       'معدل الالتزام بالوقت (%)',
        tr_perf_avg_duration:       'متوسط المدة (ساعة)',
        tr_perf_avg_rating:         'متوسط تقييم العميل',
        tr_perf_avg_delay:          'متوسط تأخر الوصول (دقيقة)',
        tr_perf_night_shift_rate:   'معدل الورديات الليلية (%)',
      },
      ...
      dashboardLabels: { transport: 'الشحن عند الطلب', parcels: 'توصيل الطرود' },
      operatorLabels: { gt: 'أكبر من (>)', gte: 'أكبر أو يساوي (≥)', lt: 'أصغر من (<)', lte: 'أصغر أو يساوي (≤)' },
      kpiCategories: { operations: 'العمليات', cost_profitability: 'التكاليف والربحية', performance: 'الأداء' },
    },
    admin: {
      title: 'لوحة الإدارة',
