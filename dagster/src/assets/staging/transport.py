...
def stg_transport_requests(
    ...
    records = [
        (
            ...
            # Dispatch
            r.get("dispatched_from_hub_id"),
            r.get("dispatched_from_hub_name"),
            int(r.get("dispatched_from_wilaya_id", 0)),
            r.get("vehicle_departure_datetime"),
            r.get("vehicle_return_datetime"),
            r.get("total_vehicle_km"),
            # Departure
            ...
            # Cost breakdown
            r["cost"].get("cout_base"),
            r["cost"].get("cout_distance_supp", 0),
            r["cost"].get("cout_ramassage", 0),
            r["cost"].get("cout_livraison", 0),
            r["cost"].get("cout_manutention", 0),
            r["cost"].get("cout_emballage", 0),
            r["cost"].get("cout_tarif_nuit", 0),
            r["cost"].get("cout_prod_frais", 0),
            r["cost"].get("cout_assurance"),
            r["cost"].get("cout_carburant"),
            r["cost"].get("cout_peage"),
            r["cost"].get("total_cost"),
            # Billing
